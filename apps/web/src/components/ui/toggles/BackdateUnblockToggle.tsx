  ...
  return (
    <>
      <button
        ...
        className={`w-full p-2.5 rounded-xl font-bold text-xs flex items-center justify-between transition-all cursor-pointer border ${
          isBackdateUnblocked
        ...
        title={
          isUserAuthorized
            ? isBackdateUnblocked
              ? 'Status Backdate: Diizinkan (Klik untuk Mengunci kembali)'
              : 'Status Backdate: Terkunci (Klik untuk Buka Otorisasi)'
      ...
      >
        ...
        <span className={`text-[10px] px-2 py-0.5 rounded-md font-mono ${
          ...
          {isBackdateUnblocked ? 'ALLOWED' : 'LOCKED'}
        </span>
      </button>
