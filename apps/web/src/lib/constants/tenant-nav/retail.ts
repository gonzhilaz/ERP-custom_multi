...
export const retailCategories: ModuleCategory[] = [
  {
    id: 'dashboard',
    name: 'Overview & Dashboard',
    icon: LayoutDashboard,
    subMenus: [
      { name: 'Dashboard Retail', href: '/' }
    ]
  },
  {
    id: 'pos',
    name: 'Kasir & POS Retail',
    icon: ShoppingCart,
    subMenus: [
      { name: 'Overview POS', href: '/pos' },
      { name: 'Kasir Touchscreen', href: '/pos/cashier' },
      { name: 'Blind Cash Audit', href: '/pos/cash-audit' },
      { name: 'Katalog Menu & SKU', href: '/pos/menu' },
  ...
  },
  {
    ...
    subMenus: [
      ...
      { name: 'Surat Penawaran B2B', href: '/crm/quotations' },
